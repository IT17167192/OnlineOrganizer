...
describe('toasterContainer', function () {
    ...
    describe('addToast', function () {
        ...
        it('should use the toast.closeHtml argument if passed', function () {
            ...
            toaster.pop({
                type: 'info', body: 'With a close button', showCloseButton: true,
        ...
        it('should render toast.closeHtml argument if not a button element', function () {
            ...
            toaster.pop({
                type: 'info', body: 'With close text', showCloseButton: true,
...
describe('toastContainer -> addToast -> bodyOutputType.html with ngSanitize', function () {
    ...
    it('should remove unsafe attributes if \'html\' bodyOutputType', function () {
        ...
        toaster.pop({
            bodyOutputType: 'html', body: '<p style="color:blue">an html\n' +
